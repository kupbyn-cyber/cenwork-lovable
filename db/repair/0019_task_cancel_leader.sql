-- TASK-FIX-04 — Leader được hủy Task như Admin/CMO (không giới hạn Team/Dự án).
...
BEGIN
  ...
  -- Admin, CMO và Leader có cùng quyền hủy mọi Task hợp lệ.
  ...
  -- Người tạo được hủy Task của mình khi chưa bắt đầu.
