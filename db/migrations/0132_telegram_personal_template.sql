-- NOTI-FIX-01 — Mẫu Telegram cá nhân: domain production mới + nội dung in đậm an toàn.
-- Chỉ ảnh hưởng telegram_compose (notification cá nhân). Báo cáo ngày Group/Topic không đổi.

-- 1) Domain chính thức mới.
...
-- 2) Escape dữ liệu động theo chuẩn HTML của Telegram (& < > là bắt buộc).
...
-- 3) Mẫu thông báo cá nhân (parse_mode=HTML do dispatcher đặt khi thấy thẻ <b>).
--    In đậm theo TỪNG DÒNG để khi tin quá dài bị cắt theo dòng, thẻ vẫn luôn cân bằng.
