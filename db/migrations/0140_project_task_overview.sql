-- CEN-PERF-05 — Lazy load Task theo Dự án.
-- 1) project_task_overview(): aggregate KPI Task cho MỌI dự án nhìn thấy được (1 query, không N+1),
--    kèm cờ `mine` cho bộ lọc "Của tôi". SECURITY INVOKER nên RLS Task vẫn quyết định phạm vi.
-- 2) task_participants_visible(uuid): bản giới hạn theo một dự án, dùng khi mở rộng accordion.
